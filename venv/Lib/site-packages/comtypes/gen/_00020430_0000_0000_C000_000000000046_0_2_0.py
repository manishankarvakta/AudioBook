...
__all__ = [ 'FONTSIZE', 'Checked', 'Color', 'FONTITALIC', 'Unchecked',
           'OLE_COLOR', 'VgaColor', 'FONTNAME', 'IFont',
           'OLE_YSIZE_CONTAINER', 'Font', 'OLE_CANCELBOOL',
           'StdPicture', 'OLE_XSIZE_CONTAINER', 'StdFont',
           'OLE_HANDLE', 'FontEvents', 'OLE_YSIZE_HIMETRIC',
           'OLE_XPOS_PIXELS', 'Picture', 'FONTBOLD', 'IPicture',
           'OLE_XSIZE_HIMETRIC', 'IFontEventsDisp',
           'OLE_XSIZE_PIXELS', 'Monochrome', 'IPictureDisp',
           'OLE_YPOS_CONTAINER', 'OLE_XPOS_HIMETRIC',
           'FONTSTRIKETHROUGH', 'Default', 'LoadPictureConstants',
           'IFontDisp', 'OLE_YPOS_HIMETRIC', 'OLE_OPTEXCLUSIVE',
           'OLE_YPOS_PIXELS', 'OLE_TRISTATE', 'OLE_XPOS_CONTAINER',
           'Gray', 'FONTUNDERSCORE', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_YSIZE_PIXELS']
from comtypes import _check_version; _check_version('1.1.10', 1536996502.167130)
